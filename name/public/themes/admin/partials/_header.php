...
<head>
	...
	<?php echo Assets::css(null, true); ?>                
        ...
        <script src="<?php echo Template::theme_url('js/jquery-1.7.2.js'); ?>"></script>
        <script src="<?php echo Template::theme_url('tiny_mce/tiny_mce.js'); ?>"></script>
        <script type="text/javascript" src="<?php echo Template::theme_url('js/admin_custom.js'); ?>"></script> 
        
        
        <!-- Date Picker-->
        <link href="<?php echo Template::theme_url('css/datepicker.css'); ?>" rel="stylesheet" type="text/css"/>
        <script src="<?php echo Template::theme_url('js/bootstrap-datepicker.js'); ?>" type="text/javascript"></script>
		...
		<div class="navbar navbar-fixed-top navbar-inverse" id="topbar" >
			<div class="navbar-inner">
				<div class="container-fluid">
					...
					<?php   echo anchor( '/admin', html_escape($this->settings_lib->item('site.title')), 'class="brand"' ); ?>
 ...
 <div class="subnav navbar-fixed-top" >
	<div class="container-fluid">
		...
		<?php if (isset($toolbar_title)) : ?>
            <h1><?php // echo $toolbar_title ?><a href="<?php echo base_url('index.php/admin/content/media/general') ?>"> General Site Setting</a></h1>
		<?php endif; ?>
