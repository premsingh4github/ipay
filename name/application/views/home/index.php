...
<div class="main-header" style="border-bottom: 1px solid #85abb3;">
    <div class="container clearfix">
        <!-- logo  -->
        <div id="logo">
            <a href="<?php echo base_url(); ?>"><img src="<?php echo base_url(); ?>themes/ipay/images/logo-ipay.png" alt="iPay" width="109" height="77" class="img-responsive"></a>
        </div>
        <div class="top-social pull-right">
            ...
            if ($this->social_link_model->count_by(array('status' => 1)) > 0) {
                foreach ($social_links as $social_link) {
                    ?>
                    <a target="_blank" href="<?php echo $social_link->url; ?>"><img src="<?php echo $social_link->icon; ?>" alt="<?php echo $social_link->alt; ?>" width="37" height="37"/></a> 
                    <?php
                }
            }
            ?>
        ...
        <div class="container">
            ...
            <div class="row wrap">
                <div class="col-md-6">
                    ...
                    <p style="font-weight: 300;"><?php echo $banners->subtitle ?></p>
