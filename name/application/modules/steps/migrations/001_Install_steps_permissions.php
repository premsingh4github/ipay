...
class Migration_Install_steps_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'STEPS.Content.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'STEPS.Content.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'STEPS.Content.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'STEPS.Content.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
