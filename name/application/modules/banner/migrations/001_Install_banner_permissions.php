...
class Migration_Install_banner_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Banner.Content.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Banner.Content.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Banner.Content.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Banner.Content.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
