...
<div class="admin-box">
	<h3>Banner</h3>
	<?php echo form_open($this->uri->uri_string(), 'name="banner_form" id="banner_form" class="form-horizontal" '); ?>
        <fieldset>
...
<!--			<div class="control-group <?php echo form_error('position') ? 'error' : ''; ?>">
			...
			<div class="control-group <?php echo form_error('from') ? 'error' : ''; ?>">
				...
				<div class='controls'>
                                    <input class="datepicker" id='banner_from' type='text' name='banner_from' maxlength="255" value="<?php echo set_value('banner_from', isset($banner['from']) ? $banner['from'] : ''); ?>" />
			...
			<div class="control-group <?php echo form_error('end_date') ? 'error' : ''; ?>">
				...
				<div class='controls'>
					<input  type="text" class="datepicker" id="banner_end_date" name='banner_end_date' maxlength="255" value="<?php echo set_value('banner_end_date', isset($banner['end_date']) ? $banner['end_date'] : ''); ?>" />
                                        <span class='help-inline'><?php echo form_error('end_date'); ?>(mm/dd/yyyy)</span>
                                        <div class="form-actions" id="check_time" style="display:none;">
