	...
	<?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>
		<fieldset>
			...
			<div class="control-group <?php echo form_error('image') ? 'error' : ''; ?>">
				<?php echo form_label('Department Banner Image'. lang('bf_form_label_required'), 'department_image', array('class' => 'control-label') ); ?>
				<div class='controls'>
                    ...
                    <div class="control-group <?php echo form_error('button_icon') ? 'error' : ''; ?>">
                        <?php echo form_label('Department Icon', 'banner_button_icon', array('class' => 'control-label')); ?>
                        <div class='controls'>
                            <input id='banner_button_icon' type='text' name='logo' maxlength="255" value="<?php echo set_value('logo', isset($banner['logo']) ? $banner['logo'] : ''); ?>" />
...
<!--			<div class="control-group <?php echo form_error('status') ? 'error' : ''; ?>">
			...
			<div class="form-actions">
				<input type="submit" name="save" class="btn btn-primary" value="<?php echo lang('department_action_create'); ?>"  />
				<?php echo lang('bf_or'); ?>
