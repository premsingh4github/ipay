...
class Migration_Install_partner_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Partner.Content.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Partner.Content.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Partner.Content.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Partner.Content.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
