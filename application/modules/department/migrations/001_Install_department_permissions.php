...
class Migration_Install_department_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Department.Content.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Department.Content.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Department.Content.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Department.Content.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
