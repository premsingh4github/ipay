                                                        ...
                                                        <div class="form-wizard-steps">
                                                            <ul class="wizard-steps">
                                                                <?php   $i =0;
                                                                 ...
                                                                 <li class="<?php  if($i== 0){echo 'active' ;} $i++; ?>" data-target="#step<?php echo $step->ID; ?>"> <a href="#tab<?php echo $step->ID; ?>" data-toggle="tab"> <span class="step"><?php echo $i; ?></span> <span class="title"><?php echo $step->step_title; ?></span> </a> </li>        
                                                                        
                                                                <?php   }
                                                                
                                                                 
                                                                ?>
<!--                                                                <li class="active" data-target="#step1"> <a href="#tab1" data-toggle="tab"> <span class="step">1</span> <span class="title">Find Agent</span> </a> </li>
                                                                <li data-target="#step2" class=""> <a href="#tab2" data-toggle="tab"> <span class="step">2</span> <span class="title">Get your ID</span> </a> </li>
                                                                <li data-target="#step3" class=""> <a href="#tab3" data-toggle="tab"> <span class="step">3</span> <span class="title">Fill Form</span> </a> </li>
                                                                <li data-target="#step4" class=""> <a href="#tab4" data-toggle="tab"> <span class="step">4</span> <span class="title">Send Money!<br></span> </a> </li>-->
                                                            </ul>
                                                            <div class="clearfix"></div>
                                                        </div>
                                                        <div class="tab-content transparent">
                                                            ...
                                                            $i =0;
                                                                foreach($steps as $step){ ?>
                                                            <div class="tab-pane <?php if($i== 0){echo 'active' ;} $i++; ?>" id="tab<?php echo $step->ID; ?>"> <br>
