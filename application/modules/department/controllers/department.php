...
//                    Template::render();
                 ...
                 return $this->load->view('department/contact');   
                }
              else{
                  redirect(base_url()); 
              } 
        ...
        public function footer(){
           return $this->load->view('department/footer');
        }
        public function rates(){
           return $this->load->view('department/rates');
        }
        public function banner(){
           return $this->load->view('department/banner');
        }
