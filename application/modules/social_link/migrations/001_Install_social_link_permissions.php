...
class Migration_Install_social_link_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Social_Link.Content.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Social_Link.Content.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Social_Link.Content.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Social_Link.Content.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
